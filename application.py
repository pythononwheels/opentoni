...
from opentoni.database.sqldblib import Base, Session, engine
from opentoni.config import myapp
from opentoni.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'opentoni.handlers.' + m)    
            try:
                mod = importlib.import_module('opentoni.handlers.' + m)
            except:
                pass
            #print(dir(mod))
