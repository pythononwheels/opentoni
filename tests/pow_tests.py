...
class TestClass:
    ...
    def test_server(self):
        ...
        import opentoni.server
        import requests
        import opentoni.config as cfg
        import time
        p = Process(target=opentoni.server.main)
        p.start()
    ...
    def test_generate_model(self):
        ...
        import opentoni.generate_model as gm
        import uuid
        import os.path
        ret = gm.generate_model(MODELNAME, "sql", appname="opentoni")
    ...
    def test_model_type(self):
        ...
        from opentoni.models.sql.pow_test_model import PowTestModel
        m = PowTestModel()
    ...
    def test_sql_dbsetup(self):
        ...
        import opentoni.init_migrations
        import os
        os.chdir("..")
        r = opentoni.init_migrations.init_migrations()
        assert r == True
    ...
    def test_sql_migration(self):
        ...
        import opentoni.generate_migration
        import os
        os.chdir("..")
        script = opentoni.generate_migration.generate_migration(message="pow_test")
    ...
    def test_sql_dbupdate(self):
        ...
        import opentoni.update_db
        import os, time
        ret = None
        os.chdir("..")
        time.sleep(1)
        try:
            ret = opentoni.update_db.migrate("up")
