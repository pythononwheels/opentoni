from opentoni.powlib import pluralize
import datetime
...
from opentoni.powlib import merge_two_dicts
from opentoni.encoders import pow_json_serializer
from opentoni.decoders import pow_json_deserializer
...
class ModelObject():
    ...
    def init_from_dict(self, d, ignore=True):
        ...
        """
        from opentoni.decoders import pow_init_from_dict_deserializer
