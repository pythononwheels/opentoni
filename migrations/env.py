...
from opentoni.powlib import get_class_name
from opentoni.config import myapp
from opentoni.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('opentoni.models.sql.' + m)
...
#from opentoni.dblib import Base
